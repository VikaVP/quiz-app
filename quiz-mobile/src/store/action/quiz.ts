...
export const getDataQuiz = async (pageSize: number, page: number) => {
  try {
    const data = await axios.get(
      `${API_URL}/quiz?page_size=${pageSize}&page_number=${page}`,
    );
...
export const createQuiz = async (datas: any) => {
  try {
    const data = await axios.post(`${API_URL}/quiz/add`, {
      ...datas,
    });
...
export const updateQuiz = async (datas: any) => {
  try {
    const data = await axios.put(`${API_URL}/quiz/update`, {
      ...datas,
    });
...
export const deleteQuiz = async (id: number) => {
  try {
    const data = await axios.delete(`${API_URL}/quiz/${id}`);
...
export const getTimerQuiz = async () => {
  try {
    const data = await axios.get(`${API_URL}/quiz/timer`);
...
export const updateTimerQuiz = async (datas: any) => {
  try {
    const data = await axios.put(`${API_URL}/quiz/timer`, {
      ...datas,
    });
...
export const getTryQuiz = (): ThunkAction<Promise<void>, {}, {}, AnyAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, AnyAction>): Promise<void> => {
    ...
    try {
      const data = await axios.get(`${API_URL}/quiz/try`);
